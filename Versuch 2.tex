...
\fbox{
  ...
  \\
   Aluminium-Kristall\\
 \quad $ N_A= (7,19 \ \cdot 10^{23}  \pm 2\cdot10^{21}) {~} \ \mathrm{mol^{-1}} $\\
   \\
 Lithiumfluoridkristall\\
\quad $ N_A = (6,36 \ \cdot 10^{23} \pm 8 \cdot 10^{21}){~}\mathrm{mol^{-1}} $\\
 \\
 Calciumfluoridkristall\\
 \quad $N_A = (5,985 \ \cdot 10^{23} \pm 6 \cdot 10^{20}) {~} \mathrm{mol^{-1}}$\\
 \\
  \end{minipage}
}
\end{Large}
